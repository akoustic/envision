...
String txt = "";
String txt1 =
    "Upload or take an image to figure out the denomination of the note";
void main() {
  runApp(new MaterialApp(
    debugShowCheckedModeBanner: false,
    title: "Note Denomination Classifier",
    home: new MyApp(),
  ));
}
...
class _MyAppState extends State<MyApp> {
  ...
  void upload(File imageFile) async {
    ...
    String base = "https://nobuttonaudio.onrender.com";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        centerTitle: true,
        title: new Text("Note Denomination Classifier"),
      ),
      body: new Container(
        child: Center(
          child: Column(
